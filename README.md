...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/decasu-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15346&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/decasu-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `decasu` can be installed with:

```
conda install decasu
```

It is possible to list all of the versions of `decasu` available on your platform with:
